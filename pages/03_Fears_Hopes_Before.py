...
with left_col:
    ...
    fears_text = st.text_area("Fear description", height=100, placeholder="Write your fears here", label_visibility="collapsed", key="fears_text")
...
with right_col:
    ...
    hopes_text = st.text_area("Hope description", height=100, placeholder="Write your hopes here", label_visibility="collapsed", key="hopes_text")
...
with col_prev:
    page3_prev = st.button("← Previous")
with col_next:
    page3_next = st.button("Next →")
